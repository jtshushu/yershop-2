...
<div class="tab-content">						
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item" style="color:red">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="orderid" value="<?php echo ((isset($info["orderid"]) && ($info["orderid"] !== ""))?($info["orderid"]):''); ?> disabled="disabled">
			</div>
		</div>
...
<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="express" value="<?php echo ($info["tool"]); ?>">
			</div>
		</div>
<div class="form-item">
			<label class="item-label">快递单号<span class="check-tips">（发货的快递单号）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="express_code" value="<?php echo ($info["toolid"]); ?>">
			</div>
</div>
<div class="form-item">
	...
	<table  id="table" class="gridtable" width="100%">
        <thead>
		 ...
		 <td align="center"><?php echo ($vo["goodid"]); ?></td>
                <td><?php echo (get_good_name($vo["goodid"])); ?></td>
		  ...
		  <div ><?php if(is_array($detail)): $i = 0; $__LIST__ = $detail;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><p>小计：<?php echo ($vo["total"]); ?>元 </p> 
		   <p>运费：<?php echo ($vo["ship_price"]); ?>元</p> 
		  
		  <p>总金额： <?php echo ($vo["total_money"]); ?>元 </p>
		   <p>下单时间：<?php echo (date('Y-m-d H:i:s',$vo["create_time"])); ?></p><?php endforeach; endif; else: echo "" ;endif; ?> </div>
 <div ><?php if(is_array($trans)): $i = 0; $__LIST__ = $trans;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><p>收件人<?php echo ($vo["realname"]); ?></p><p>联系方式 <?php echo ($vo["cellphone"]); ?> </p><p>地址 <?php echo ($vo["province"]); ?> <?php echo ($vo["city"]); ?> <?php echo ($vo["area"]); echo ($vo["address"]); ?></p> </div><?php endforeach; endif; else: echo "" ;endif; ?>
		  </div>
	</div>
