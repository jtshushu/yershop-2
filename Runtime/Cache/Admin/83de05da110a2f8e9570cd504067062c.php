...
<div class="form-item">
 ...
 <div ><?php if(is_array($trans)): $i = 0; $__LIST__ = $trans;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><p>收件人<?php echo ($vo["realname"]); ?></p><p>联系方式 <?php echo ($vo["cellphone"]); ?> </p><p>地址 <?php echo ($vo["province"]); ?> <?php echo ($vo["city"]); ?> <?php echo ($vo["area"]); ?> <?php echo ($vo["address"]); ?></p> </div><?php endforeach; endif; else: echo "" ;endif; ?>
		  </div>
	</div>
