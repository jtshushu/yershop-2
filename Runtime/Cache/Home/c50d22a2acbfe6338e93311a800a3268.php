...
<?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><div class="item">
   ...
   <section>
      ...
      <dd><?php if(is_array($childlist)): $i = 0; $__LIST__ = $childlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Article/index/?pid='.$vo['id']);?>"><?php echo ($vo["title"]); ?>(<?php echo (get_tuan_count($vo["id"])); ?>)</a><?php endforeach; endif; else: echo "" ;endif; ?> </dd></dl> 
       </div><?php endif; ?>  <?php $category['id']=I('pid'); ?> 
