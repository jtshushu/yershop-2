...
<div class="center_right" id="MemberCenterCtrl" style="display: block;">
	...
	<h3 class="cr_h3 cr_h3_gray">历史评价统计</h3>

	
	<div class="personal_info">
				<p><span class="rate-icon rate-ok"><img src="/Public/Home/images/ok.png">好评</span><?php echo ($best); ?>个<span class="rate-icon rate-ok"><img src="/Public/Home/images/bad.png">差评</span><?php echo ($bad); ?>个<span class="rate-icon rate-ok"><img src="/Public/Home/images/common.png">一般</span><?php echo ($common); ?>个</p>
			</div>
	<h4><span>评价列表</span></h4>
 ...
 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$co): $mod = ($i % 2 );++$i;?><tr class="comment_list"><td width="10%" align="center"><?php if($co['commentscore']==1){echo "<img src='/Public/Home/images/bad.png'>" ;}; if($co['commentscore']==2){echo "<img src='/Public/Home/images/common.png'>" ;}; if($co['commentscore']==3){echo "<img src='/Public/Home/images/ok.png'>" ;}; ?><td width="35%" align="center"><?php echo ($co["content"]); ?></br><?php echo (date('Y-m-d H:i:s',$co["create_time"])); ?></td>
			  <td width="30%" align="center"> <a href="<?php echo U('Article/detail?id='.$co['goodid']);?>" ><?php echo (get_good_name($co["goodid"])); ?> </a>￥<?php echo (get_good_price($co["goodid"])); ?> </td>
			   <th width="25%"></th>
