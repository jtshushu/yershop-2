...
/Public/Home/js/jquery.tips.js"></script>
...
$(document).ready(function(){ 
   ...
   <div class="count">
    <dl><dt><?php if(($faceid) > "0"): ?><a href='<?php echo U("member/index");?>'><img src="/Public/Home/images/info.jpg" width="100" height="100"/></a><?php else: ?>
	<img src="<?php echo (get_cover($faceid,'path')); ?>"  /><?php endif; ?>
	</dt>
	<dd>	<a href="" class="pinkred" title="<?php echo (get_nickname($uid)); ?>">Hi,<?php echo (get_nickname($uid)); ?></a> 欢迎您光临<?php echo C('SITENAME');?>！</dd>
	<dd>您的上一次登录时间是：<?php echo (date('Y-m-d H:i',$time["last_login_time"])); ?></dd>
	<dd>账户安全<span ><div class="progress_container"><div class="progress_bar tip" title="78%"></div></div></span></dd>
	
	</dl>
   <p>订单提醒：待支付订单(<span class="red"><?php echo ((isset($onum) && ($onum !== ""))?($onum):"0"); ?></span>)&nbsp;&nbsp;待确认订单(<span class="red"><?php echo ((isset($cnum) && ($cnum !== ""))?($cnum):"0"); ?></span>)&nbsp;&nbsp;购物车中的商品(<span class="red"><?php echo ((isset($shopnum) && ($shopnum !== ""))?($shopnum):"0"); ?></span>)</p>
   <p>消息管理：站内信(<span class="red"><?php echo ($ecount); ?></span>)&nbsp;&nbsp;优惠券(<span class="red"><?php echo ((isset($num) && ($num !== ""))?($num):"0"); ?>张</span>)&nbsp;&nbsp;积分(<span class="red" id="score"><?php echo (get_score($uid)); ?></span>)</p>
   </div>
 <div class="qiandao"><a href="javascript:void(0)" class="pf_qiandao" onclick="qiandao()">每日签到</a> </div>
	</div>

<div class="order_namelist">
<span><a href='<?php echo U("center/allorder");?>' class="red">所有订单<?php echo ($anum); ?></a></span>
<span><a href='<?php echo U("center/needpay");?>' class="red">待支付订单<?php echo ($onum); ?></a></span>
<span><a href='<?php echo U("center/tobeshipped");?>' class="red">待发货订单<?php echo ($dnum); ?></a></span>
<span><a href='<?php echo U("center/tobeconfirmed");?>' class="red">待确认订单<?php echo ($cnum); ?></a></span>
</div>
	<script> //tab菜单切换
$(document).ready(function () {$(".order_namelist span").eq(0).addClass("active");
	...
	<?php if(empty($list)): ?><div class="personal_info_none_goods">
				...
				<a rel="nofollow" href="<?php echo U("index/index");?>" class="ping_btn">马上购物</a>
				<div class="cb"></div>
			</div>
	<?php else: ?>
...
<form action='<?php echo U("Shopcart/delorder");?>' method="post" name="delform" >
		...
		<!-- 左边商品区域开始 -->  
		 ...
		 <span class="dd"><?php echo ($vo["parameters"]); ?></span>
		  ...
		  <span class="c2"><?php echo ($vo["num"]); ?></span> 
		    <span class="c2">  <?php if($vo['status']==1||$vo['status']==2){echo "无" ;}; if($vo['status']==3){echo "<a  href='index.php?s=/Home/back/index/id/".$vo['id']."'>退货</a>&nbsp;/"."<a  href='index.php?s=/Home/Exchange/index/id/".$vo['id']."'>换货</a>" ;}; if($vo['status']==4){echo "<a  class='red' href='index.php?s=/Home/back/detail/id/".$vo['id']."'>退货审核中</a>&nbsp;";}; if($vo['status']==5){echo "<a  class='red' href='index.php?s=/Home/back/detail/id/".$vo['id']."'>同意退货</a>&nbsp;";}; if($vo['status']==6){echo "<a  class='red' href='index.php?s=/Home/back/detail/id/".$vo['id']."'>退货中</a>&nbsp;";}; if($vo['status']==7){echo "<a  class='red' href='index.php?s=/Home/back/detail/id/".$vo['id']."'>退货被拒绝</a>&nbsp;";}; if($vo['status']==8){echo "<a  class='red' href='index.php?s=/Home/back/detail/id/".$vo['id']."'>退货完成</a>&nbsp;";}; if($vo['status']==-4){echo "<a  class='red' href='index.php?s=/Home/Exchange/detail/id/".$vo['id']."'>换货审核中</a>&nbsp;";}; if($vo['status']==-5){echo "<a  class='red' href='index.php?s=/Home/Exchange/detail/id/".$vo['id']."'>同意换货</a>&nbsp;";}; if($vo['status']==-6){echo "<a  class='red' href='index.php?s=/Home/Exchange/detail/id/".$vo['id']."'>换货中</a>&nbsp;";}; if($vo['status']==-7){echo "<a class='red'  href='index.php?s=/Home/Exchange/detail/id/".$vo['id']."'>换货被拒绝</a>&nbsp;";}; if($vo['status']==-8){echo "<a  class='red' href='index.php?s=/Home/Exchange/detail/id/".$vo['id']."'>换货完成</a>&nbsp;";}; if($vo['iscomment']==1){echo "<br/><a  href='index.php?s=/Home/comment/index/id/".$vo['id']."'>评价商品</a>";}; if($vo['iscomment']==2){echo "<br/><a  href='index.php?s=/Home/comment/index/id/".$vo['id']."'>已评价</a>";}; ?></span>
		  </div><?php endforeach; endif; else: echo "" ;endif; ?> 
		  </div>
		  <!-- 左边商品结束 -->  
 ...
 <div class="total-area"><p>￥<?php echo ($po["total_money"]); ?></p><p>(运费￥<?php echo ($po["ship_price"]); ?>)</p> 
       ...
       <!-- 列表详情区域结束 -->
	   </div><?php endforeach; endif; else: echo "" ;endif; ?>	 </form>
   <!-- 分页 -->
        <div class="page">
<?php echo ($page); ?>
        </div><?php endif; ?>
...
//全选的实现
  ...
  function qiandao(){
var b='<?php echo U("Sign/index");?>';
  $.ajax({
             type: "GET",
             url: "<?php echo U("Sign/index");?>",
             data: {username:b},
             dataType: "json",
