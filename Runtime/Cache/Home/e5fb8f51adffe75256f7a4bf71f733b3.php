...
<span><a href='<?php echo U("center/tobeconfirmed");?>' class="red">待确认订单</a></span>
	...
	<script> //tab菜单切换
$(document).ready(function () {$(".order_namelist span").eq(3).addClass("active");
	...
	<?php else: ?><form action='<?php echo U("order/del");?>' method="post" name="delform" >
	  ...
	  <span class="good-status">交易状态</span> <span class="deal-action">交易操作</span></div>
		...
		<?php if(($po['status']) > "2"): ?><b><a href="<?php echo U('order/del?tag='.$po['tag']);?>" ><img src="/Public/Home/images/iconfont-lajixiang.png" width="20" height="20"></a></b><?php endif; ?>
			   </div>
         <!-- 列表详情区域开始 -->  
 ...
 <div class="total-area"><p>￥<?php echo ($po["total_money"]); ?></p><p>(运费￥<?php echo ($po["ship_price"]); ?>)</p> 		    </div>
		     <div class="deal-area">
			<p class="red"> 
