...
<div class="center_right" id="MemberCenterCtrl" style="display: block;">
	...
	<?php if(empty($info)): ?><div class="personal_info_none_goods">
				<p>没有登录，<a href='<?php echo U();?>' class="red">请先登录</a></p>
	...
	<div class="controls">
						...
						<input type="hidden" name="face" id="face" value="<?php echo ((isset($info['face']) && ($info['face'] !== ""))?($info['face']):''); ?>"/>
						<div class="upload-img-box">
						<?php if(!empty($info['face'])): ?><div class="upload-pre-item"><img src="<?php echo (get_cover($info["face"],'path')); ?>"/></div><?php endif; ?>
						<?php if(empty($info['face'])): ?><img src="/Public/Home/images/pic_head_34_s.gif" width="100" height="100"/><?php endif; ?>
